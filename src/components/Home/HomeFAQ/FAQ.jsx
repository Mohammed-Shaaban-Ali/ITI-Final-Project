  ...
  return (
    <div className="faq-section">
      <div className="faq-container">
        <div className="faq-header animation">
        ...
        <div className="faq-list">
          <ul>
            {[1, 2, 3].map((item) => (
              <li key={item} className="faq-item ">
                <div className="faq-question-container animation">
                  ...
                  <div className="faq-question">
                    <h4>What could possibly be your first question?</h4>
                  </div>
                </div>
                <div className="faq-answer-container animation">
